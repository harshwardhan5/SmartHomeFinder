...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">ondary double-down-line text-center mb-5">What We Do</h2></div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce convallis dolor in dolor hendrerit, nec varius arcu ullamcorper. Integer tincidunt bibendum est, non varius sapien. Vivamus in ante at erat consequat facilisis.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
